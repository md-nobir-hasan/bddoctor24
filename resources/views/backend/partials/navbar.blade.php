<nav :class="{ 'start-64 -end-64 md:start-0 md:end-0': sidebar, 'start-0 end-0 md:start-64': !(sidebar) }"
    class="fixed z-50 flex flex-row items-center justify-between px-6 py-2 mt-0 transition-all duration-500 ease-in-out bg-white shadow-sm flex-nowrap start-0 md:start-64 end-0 dark:bg-gray-800"
    id="desktop-menu">
    <!-- sidenav button-->
    <button id="navbartoggle" type="button"
        ...
        <svg x-description="Icon sidebar" x-state:on="Menu sidebar" x-state:off="Menu closed" class="hidden w-8 h-8"
        ...
        <svg x-description="Icon closed" x-state:on="Menu sidebar" x-state:off="Menu closed" class="block w-8 h-8"
    ...
    <form class="hidden mx-5 sm:inline-block md:hidden lg:inline-block">
        <div class="relative flex flex-wrap items-stretch w-full">
            <input type="text"
                class="relative flex-grow flex-shrink max-w-full px-4 py-2 overflow-x-auto text-sm leading-5 text-gray-800 bg-gray-100 border border-gray-100 rounded-s focus:outline-none focus:border-gray-200 focus:ring-0 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600"
                placeholder="Search…" aria-label="Search">
            <div class="flex -me-px">
                <button
                    class="flex items-center px-4 py-2 leading-5 text-gray-100 bg-indigo-500 border border-indigo-500 -ms-1 rounded-e hover:text-white hover:bg-indigo-600 hover:ring-0 hover:border-indigo-600 focus:bg-indigo-600 focus:border-indigo-600 focus:outline-none focus:ring-0"
                    type="button">
    ...
    <ul class="flex mt-2 ms-auto">
        ...
        <li x-data="{ open: false }" class="relative">
            <a href="javascript:;" class="flex px-4 py-3 text-sm rounded-full focus:outline-none"
                aria-controls="mobile-canvas" @click="open = !open">
                <span class="sr-only">Customizer</span>
                <svg x-description="Icon closed" x-state:on="Menu open" x-state:off="Menu closed" class="block w-6 h-6"
            ...
            <!-- Right Offcanvas -->
            <div class="fixed inset-0 z-50 w-full h-full" id="mobile-canvas" x-description="Mobile menu" x-show="open"
                style="display: none;">
                <!-- bg open -->
                <span class="fixed inset-x-0 top-0 w-full h-full bg-gray-900 bg-opacity-70"></span>

                <nav id="mobile-nav"
                    class="fixed top-0 z-40 flex flex-col h-full overflow-auto bg-white end-0 w-72 dark:bg-gray-800 scrollbars show"
                        ...
                        <div class="flex flex-row">
                            <div
                                ...
                                <input type="checkbox" name="lightdark" id="lightdark"
                                    class="absolute block w-5 h-5 bg-white border-2 rounded-full appearance-none cursor-pointer toggle-checkbox dark:bg-gray-900 dark:border-gray-700" />
                                <label for="lightdark"
                                    class="block h-5 overflow-hidden bg-gray-300 rounded-full cursor-pointer toggle-label dark:bg-gray-700"></label>
                            </div>
                    ...
                    <div id="customcolor" class="px-6 py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="relative my-3">
                            ...
                            <div id="custyellow" title="yellow"
                                class="inline-block p-3 me-1.5 bg-yellow-500 hover:opacity-90 rounded-full cursor-pointer">
                            </div>
                            ...
                            <div id="custpink" title="pink"
                                class="inline-block p-3 me-1.5 bg-pink-500 hover:opacity-90 rounded-full cursor-pointer">
                            </div>
                    ...
                    <div class="px-6 pt-6">
                        <div x-data="{ open: true }" x-show="open"
                            class="relative flex items-center justify-between p-3 mb-4 text-yellow-900 bg-yellow-100 rounded-lg">
                            <div>
                                How to apply? please read the documentation on <a href="/docs/customize.html"
                                    class="font-semibold underline">Customize page</a>
                            </div>
        ...
        <!-- messages -->
        <li x-data="{ open: false }" class="relative">
            <a href="javascript:;" class="flex px-4 py-3 text-sm rounded-full focus:outline-none" id="messages"
                @click="open = ! open">
                <div class="relative inline-block">
                    ...
                    <span
                        class="absolute flex justify-center px-1 text-xs text-center text-white bg-pink-500 rounded-full -top-2 -end-1"><span
            ...
            <div x-show="open" @click.outside="open = false"
                ...
                class="w-72 absolute -end-24 sm:-end-28 md:end-0 rounded top-full z-50 py-0.5 text-start  bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md"
                style="display: none;">
                <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        ...
                        <div x-data="{ open: false }" class="absolute top-0 end-0">
                            <a @click="open = ! open" href="javascript:;" class="inline-block me-2"
                            ...
                            <div x-show="open" @click.outside="open = false"
                                class="absolute z-10 origin-top-right bg-white rounded end-0 dark:bg-gray-700"
                ...
                <div class="overflow-y-auto max-h-60 scrollbars show">
                            ...
                            <div class="flex-shrink w-1/4 max-w-full px-2 text-center">
                                <div class="relative">
                                    <img src="{{ asset('src/img/avatar/avatar2.png') }}"
                                        class="w-10 h-10 mx-auto rounded-full" alt="Daniel Esteban">
                                    <span title="online"
                                        class="flex justify-center absolute -bottom-0.5 end-2 text-center bg-green-500 border border-white w-3 h-3 rounded-full"></span>
                                </div>
                            </div>
                    ...
                    <a href="/#">
                        <div
                            ...
                            <div class="flex-shrink w-1/4 max-w-full px-2 text-center">
                                <div class="relative">
                                    <img src="{{ asset('src/img/avatar/avatar3.png') }}"
                                        class="w-10 h-10 mx-auto rounded-full" alt="Carlos Garcia">
                                    <span title="busy"
                                        class="flex justify-center absolute -bottom-0.5 end-2 text-center bg-pink-500 border border-white w-3 h-3 rounded-full"></span>
                                </div>
                            </div>
                            <div class="flex-shrink w-3/4 max-w-full px-2">
                    ...
                    <a href="/#">
                        <div
                            ...
                            <div class="flex-shrink w-1/4 max-w-full px-2 text-center">
                                <div class="relative">
                                    <img src="{{ asset('src/img/avatar/avatar4.png') }}"
                                        class="w-10 h-10 mx-auto rounded-full" alt="Steven Rey">
                                    <span title="offline"
                                        class="flex justify-center absolute -bottom-0.5 end-2 text-center bg-gray-500 border border-white w-3 h-3 rounded-full"></span>
                                </div>
                            </div>
                            <div class="flex-shrink w-3/4 max-w-full px-2">
                    ...
                    <a href="/#">
                        <div
                            class="flex flex-row flex-wrap items-center py-2 border-b border-gray-200 dark:border-gray-700 dark:hover:bg-gray-900 dark:hover:bg-opacity-20 hover:bg-gray-100">
                            <div class="flex-shrink w-1/4 max-w-full px-2 text-center">
                                <div class="relative">
                                    <img src="{{ asset('src/img/avatar/avatar.png') }}"
                                        class="w-10 h-10 mx-auto rounded-full" alt="Roman Davis">
                                    <span title="offline"
                                        class="flex justify-center absolute -bottom-0.5 end-2 text-center bg-gray-500 border border-white w-3 h-3 rounded-full"></span>
                                </div>
                            </div>
        ...
        <!-- notification -->
        <li x-data="{ open: false }" class="relative">
            <a href="javascript:;" class="flex px-4 py-3 text-sm rounded-full focus:outline-none" id="notify"
                @click="open = ! open">
                <div class="relative inline-block">
            ...
            <div x-show="open" @click.outside="open = false"
                ...
                x-transition:leave="transition-all duration-200 ease-in"
                x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95"
                class="w-72 absolute -end-16 md:end-0 rounded top-full z-50 py-0.5 text-start bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md"
                style="display: none;">
                <div class="p-3 font-normal border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
        ...
        <!-- profile -->
        <li x-data="{ open: false }" class="relative">
            <a href="javascript:;" class="flex px-3 text-sm rounded-full focus:outline-none" id="user-menu-button"
                @click="open = ! open">
                <div class="relative">
                    <img class="w-10 h-10 bg-gray-700 border border-gray-700 rounded-full"
                        src="{{ asset('src/img/avatar/avatar.png') }}" alt="avatar">
                    <span title="online"
                        class="flex justify-center absolute -bottom-0.5 end-1 text-center bg-green-500 border border-white w-3 h-3 rounded-full"></span>
                </div>
            ...
            <ul x-show="open" @click.outside="open = false"
                ...
                x-transition:leave="transition-all duration-200 ease-in"
                x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95"
                class="origin-top-right absolute end-0 rounded top-full z-50 py-0.5 text-start min-w-[12rem] bg-white dark:bg-gray-800 border dark:border-gray-700 shadow-md"
                style="display: none;">
                <li class="relative">
                    <div class="flex flex-row flex-wrap items-center px-3 py-4 -mx-4">
                        <div class="flex-shrink w-1/3 max-w-full px-4">
                            <img src="{{ asset('src/img/avatar/avatar.png') }}" class="w-10 h-10 rounded-full"
                                alt="Ari Budin">
                        </div>
                        <div class="flex-shrink w-2/3 max-w-full px-4 ps-1">
                            <div class="font-bold"><a href="/#"
                                    class="text-gray-800 dark:text-gray-300 hover:text-indigo-500">Ari Budin</a></div>
                ...
                <li class="relative">
                    <a class="block clear-both w-full px-6 py-2 whitespace-nowrap hover:text-indigo-500"
                        href="/#">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="inline w-4 h-4 me-2 bi bi-gear" viewBox="0 0 16 16">
                            <path
                                d="M8 4.754a3.246 3.246 0 1 0 0 6.492 3.246 3.246 0 0 0 0-6.492zM5.754 8a2.246 2.246 0 1 1 4.492 0 2.246 2.246 0 0 1-4.492 0z" />
                            <path
                                d="M9.796 1.343c-.527-1.79-3.065-1.79-3.592 0l-.094.319a.873.873 0 0 1-1.255.52l-.292-.16c-1.64-.892-3.433.902-2.54 2.541l.159.292a.873.873 0 0 1-.52 1.255l-.319.094c-1.79.527-1.79 3.065 0 3.592l.319.094a.873.873 0 0 1 .52 1.255l-.16.292c-.892 1.64.901 3.434 2.541 2.54l.292-.159a.873.873 0 0 1 1.255.52l.094.319c.527 1.79 3.065 1.79 3.592 0l.094-.319a.873.873 0 0 1 1.255-.52l.292.16c1.64.893 3.434-.902 2.54-2.541l-.159-.292a.873.873 0 0 1 .52-1.255l.319-.094c1.79-.527 1.79-3.065 0-3.592l-.319-.094a.873.873 0 0 1-.52-1.255l.16-.292c.893-1.64-.902-3.433-2.541-2.54l-.292.159a.873.873 0 0 1-1.255-.52l-.094-.319zm-2.633.283c.246-.835 1.428-.835 1.674 0l.094.319a1.873 1.873 0 0 0 2.693 1.115l.291-.16c.764-.415 1.6.42 1.184 1.185l-.159.292a1.873 1.873 0 0 0 1.116 2.692l.318.094c.835.246.835 1.428 0 1.674l-.319.094a1.873 1.873 0 0 0-1.115 2.693l.16.291c.415.764-.42 1.6-1.185 1.184l-.291-.159a1.873 1.873 0 0 0-2.693 1.116l-.094.318c-.246.835-1.428.835-1.674 0l-.094-.319a1.873 1.873 0 0 0-2.692-1.115l-.292.16c-.764.415-1.6-.42-1.184-1.185l.159-.291A1.873 1.873 0 0 0 1.945 8.93l-.319-.094c-.835-.246-.835-1.428 0-1.674l.319-.094A1.873 1.873 0 0 0 3.06 4.377l-.16-.292c-.415-.764.42-1.6 1.185-1.184l.292.159a1.873 1.873 0 0 0 2.692-1.115l.094-.319z" />
                ...
                <li class="relative">
                    <a class="block clear-both w-full px-6 py-2 whitespace-nowrap hover:text-indigo-500"
                        href="/#">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="inline w-4 h-4 me-2 bi bi-question-circle" viewBox="0 0 16 16">
                ...
                <li class="relative">
                    <a class="block clear-both w-full px-6 py-2 whitespace-nowrap hover:text-indigo-500"
                        href="/#">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                            class="inline w-4 h-4 me-2 bi bi-translate" viewBox="0 0 16 16">
                            <path
                ...
                <li class="relative">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="block clear-both w-full px-6 py-2 whitespace-nowrap hover:text-indigo-500">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                class="inline w-4 h-4 me-2 bi bi-box-arrow-in-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd"
                                    d="M6 3.5a.5.5 0 0 1 .5-.5h8a.5.5 0 0 1 .5.5v9a.5.5 0 0 1-.5.5h-8a.5.5 0 0 1-.5-.5v-2a.5.5 0 0 0-1 0v2A1.5 1.5 0 0 0 6.5 14h8a1.5 1.5 0 0 0 1.5-1.5v-9A1.5 1.5 0 0 0 14.5 2h-8A1.5 1.5 0 0 0 5 3.5v2a.5.5 0 0 0 1 0v-2z" />
                                <path fill-rule="evenodd"
                                    d="M11.854 8.354a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5H1.5a.5.5 0 0 0 0 1h8.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3z" />
                            </svg>
                            <!-- <i class="me-2 fas fa-sign-out-alt"></i> --> Sign out
                        </button>
                    </form>
                </li>
            </ul>

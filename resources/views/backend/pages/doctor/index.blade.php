    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Doctor</p>
            </div>
                        ...
                        <div class="flex-shrink max-w-full px-4 w-full">
                            ...
                            <div class="w-full mb-6 overflow-x-auto">
                                ...
                                <div
                                                    ...
                                                    @foreach ($data as $datum)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <form method="POST"
                                                                    action="{{ route('doctor.destroy', [$datum->id]) }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button
                                                                ...
                                                                <a href="{{ route('doctor.edit', $datum->id) }}"
                                    ...
                                    @else
                                        <h6 class="text-center">No Doctors found!!! Please create Doctor</h6>
                                    @endif
                                </div>

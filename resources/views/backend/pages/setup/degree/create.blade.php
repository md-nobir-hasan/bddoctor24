    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5 text-center">Degree</p>
            </div>
                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
                    <div class="w-full overflow-x-auto">
                        <div class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20">
                            <form method="POST" action="{{ route('setup.degree.store') }}"
                                ...
                                <div class='flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6'>
                                                            ...
                                                            <label for='is_special' class='inline-block mb-2'>Is Special</label><span class="text-danger">*</span></label>
                                                            <input id='is_special' type='text' name='is_special' placeholder='Exp:- Enter Is Special'
                                                                value='{{ old('is_special') }}' class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('is_special')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                        </div>

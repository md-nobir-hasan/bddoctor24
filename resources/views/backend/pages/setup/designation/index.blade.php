    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Designation</p>
            </div>
                        ...
                        <div class="flex-shrink max-w-full px-4 w-full">
                            ...
                            <div class="w-full mb-6 overflow-x-auto">
                                ...
                                <div
                                                    ...
                                                    @foreach ($data as $datum)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <form method="POST"
                                                                    action="{{ route('setup.designation.destroy', [$datum->id]) }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button
                                                                ...
                                                                <a href="{{ route('setup.designation.edit', $datum->id) }}"
                                    ...
                                    @else
                                        <h6 class="text-center">No Designations found!!! Please create Designation</h6>
                                    @endif
                                </div>

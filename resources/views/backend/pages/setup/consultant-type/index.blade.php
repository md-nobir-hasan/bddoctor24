    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Consultant Type</p>
            </div>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4">
                        <div class="flex-shrink max-w-full px-4 w-full">
                            <div class="md:flex md:justify-between">
                                <div>
                                    <a href="{{ route('setup.consultant-type.create') }}"
                            ...
                            <div class="w-full mb-6 overflow-x-auto">
                                ...
                                <div
                                                    ...
                                                    @foreach ($data as $datum)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <form method="POST"
                                                                    action="{{ route('setup.consultant-type.destroy', [$datum->id]) }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button
                                    ...
                                    @else
                                        <h6 class="text-center">No Consultant Types found!!! Please create Consultant Type
                                        </h6>
                                    @endif
                                </div>

    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">District</p>
            </div>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4">
                        <div class="flex-shrink max-w-full px-4 w-full">
                            <div class="md:flex md:justify-between">
                                <div>
                                    <a href="{{ route('setup.district.create') }}"
                            ...
                            <div class="w-full mb-6 overflow-x-auto">
                               {{-- <form action="#"> --}}
                                    <div
                                                        ...
                                                        @foreach ($data as $datum)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <form method="POST" action="{{ route('setup.district.destroy', [$datum->id]) }}">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button
                                                                    ...
                                                                    <a href="{{ route('setup.district.edit', $datum->id) }}"
                                        ...
                                        @else
                                            <h6 class="text-center">No Districts found!!! Please create District</h6>
                                        @endif
                                    </div>

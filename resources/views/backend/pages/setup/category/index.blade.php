    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Category</p>
            </div>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4">
                        <div class="flex-shrink max-w-full px-4 w-full">
                            <div class="md:flex md:justify-between">
                                <div>
                                    <a href="{{ route('setup.category.create') }}"
                                                        ...
                                                        @foreach ($data as $datum)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <form method="POST" action="{{ route('setup.category.destroy', [$datum->id]) }}">
                                                                        @csrf
                                                                        @method('delete')
                                                                        <button
                                                                    ...
                                                                    <a href="{{ route('setup.category.edit', $datum->id) }}"

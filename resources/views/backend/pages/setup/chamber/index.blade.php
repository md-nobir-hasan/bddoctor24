    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5">Chamber</p>
            </div>
                    ...
                    <div class="flex flex-wrap flex-row -mx-4">
                        <div class="flex-shrink max-w-full px-4 w-full">
                            <div class="md:flex md:justify-between">
                                <div>
                                    <a href="{{ route('setup.chamber.create') }}"
                            ...
                            <div class="w-full mb-6 overflow-x-auto">
                                ...
                                <div
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr class="bg-gray-100 dark:bg-gray-900 dark:bg-opacity-40">
                                                        ...
                                                        <th class="min-w-[250px]" data-sortable="" style="width: 49.5287%;">
                                                ...
                                                <tbody>
                                                    @foreach ($data as $datum)
                                                        <tr>
                                                            ...
                                                            <td> {{ $datum->map_link }}</td>
                                                            <td> {{ $datum->website_link }}</td>
                                                            ...
                                                            <td class="text-center">
                                                                <form method="POST"
                                                                    action="{{ route('setup.chamber.destroy', [$datum->id]) }}">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button
                                                                ...
                                                                <a href="{{ route('setup.chamber.edit', $datum->id) }}"
                                    ...
                                    @else
                                        <h6 class="text-center">No Chambers found!!! Please create Chamber</h6>
                                    @endif
                                </div>

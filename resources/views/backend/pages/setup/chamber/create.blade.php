    ...
    <div class="mx-auto py-2 sm:px-2">
        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full px-4 w-full">
                <p class="text-xl font-bold mt-3 mb-5 text-center">Chamber</p>
            </div>
                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
                    <div class="w-full overflow-x-auto">
                        <div class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20">
                            <form method="POST" action="{{ route('setup.chamber.store') }}"
                                ...
                                <div class='flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6'>
                                                            ...
                                                            <input id='location' type='text' name='location' placeholder='Exp:- Enter Location'
                                                                value='{{ old('location') }}' class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('location')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                            ...
                                                            <label for='map_link' class='inline-block mb-2'>Map Link</label> 
                                                            <input id='map_link' type='text' name='map_link' placeholder='Exp:- Enter Map Link'
                                                                value='{{ old('map_link') }}' class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('map_link')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                        </div><div class='flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6'>
                                                            <label for='website_link' class='inline-block mb-2'>Website Link</label> 
                                                            <input id='website_link' type='text' name='website_link' placeholder='Exp:- Enter Website Link'
                                                                value='{{ old('website_link') }}' class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('website_link')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                        </div>

                ...
                <div class="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg mb-6">
                    <div class="w-full overflow-x-auto">
                        <div class="flex-1 p-6 bg-gray-100 dark:bg-gray-900 bg-opacity-60 dark:bg-opacity-20">
                            <form method="POST" action="{{ route('setup.chamber.update',$datum->id) }}"
                                ...
                                <div class='flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6'>
                                                            ...
                                                            <input id='location' type='text' name='location' placeholder='Exp:- Enter Location'
                                                                value='{{$datum->location ? $datum->location : old('location') }}'
                                                                class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('location')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                            ...
                                                            <input id='map_link' type='text' name='map_link' placeholder='Exp:- Enter Map Link'
                                                                value='{{$datum->map_link ? $datum->map_link : old('map_link') }}'
                                                                class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('map_link')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                                            ...
                                                            <input id='website_link' type='text' name='website_link' placeholder='Exp:- Enter Website Link'
                                                                value='{{$datum->website_link ? $datum->website_link : old('website_link') }}'
                                                                class='w-full leading-5 relative py-2 px-4 rounded text-gray-800 bg-white border border-gray-300 overflow-x-auto focus:outline-none focus:border-gray-400 focus:ring-0 dark:text-gray-300 dark:bg-gray-700 dark:border-gray-700 dark:focus:border-gray-600'>
                                                            @error('website_link')
                                                                <span class='text-danger'>{{ $message }}</span>
                                                            @enderror
                                ...
                                <div class="flex-shrink max-w-full px-4 w-full md:w-1/2 mb-6">
                                    ...
                                    <select id="status"
                                        ...
                                        <option value="Active" @selected($datum->status == 'Active')>Active</option>
                                        <option value="Inactive" @selected($datum->status == 'Inactive')>Inactive</option>
                                    </select>
                                    @error('status')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
